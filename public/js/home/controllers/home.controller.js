angular.module('diplomka')
  .controller('HomeCtrl', ['$rootScope','$scope', '$location', 'API', '$mdDialog', function ($rootScope, $scope, $location, API, $mdDialog) {
    ...
    var confirm = $mdDialog.prompt()
          .title('Provide name of new folder')
    ...
    $mdDialog.show(confirm).then(function(result) {
      $scope.mainFolderTree.push(result);
    });
  };
